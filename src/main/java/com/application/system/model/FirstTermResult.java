...
public class FirstTermResult {
	...
	public FirstTermResult(float math, float arabic, float islamic, float result, String grade, String acyear) {
	...
	public FirstTermResult(float math, float arabic, float islamic, float national, float history, float science,

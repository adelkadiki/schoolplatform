...
public class FirstTerm {
	...
	public FirstTerm(float math, float arabic, float islamic) {
	...
	public FirstTerm(float math, float arabic, float islamic, float national, float history, float science) {
